...
function updateTimerDisplay()
{
    ...
    const formattendHours = displayHours < 10 ? "0" + displayHours : displayHours;
    const formattedMinutes = displayMinutes < 10 ? "0" + displayMinutes : displayMinutes;
    const formattendSeconds = displaySeconds < 10 ? "0" + displaySeconds : displaySeconds;

    timerDisplay.innerHTML = `${formattendHours}:${formattedMinutes}:${formattendSeconds}`
}
function startTimer()
{
